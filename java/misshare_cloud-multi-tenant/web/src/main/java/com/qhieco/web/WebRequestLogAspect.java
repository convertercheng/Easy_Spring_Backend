...
import com.qhieco.commonentity.LogOperationWeb;
import com.qhieco.commonentity.UserWeb;
import com.qhieco.commonrepo.LogOperationWebRepository;
import com.qhieco.constant.Status;
import com.qhieco.response.Resp;
import com.qhieco.util.LogUrl;
import com.qhieco.webservice.OptLogService;
        ...
        try {
            ...
            if (m.find() && httpServletRequest.getMethod().equalsIgnoreCase(POST_METHOD)) {
                ...
                if (opration != null && admin != null) {
                    ...
                    logAdmin.setState(Status.Common.VALID.getInt());
