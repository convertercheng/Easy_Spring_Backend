...
//        Arrays.asList(targetClass.getInterfaces()).forEach(i->System.out.println(i.getSimpleName()));
...
//    @Pointcut("@within(org.springframework.cache.annotation.CacheConfig)")
    @Pointcut("execution(public * com.qhieco.commonrepo.*.*(..))")
