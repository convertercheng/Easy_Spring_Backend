...
import com.qhieco.webbitem.security.CustomUserService;
import com.qhieco.webbitem.security.MyFilterSecurityInterceptor;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    private AdminBItemService adminBItemService;
        ...
        http.cors().and()
                ...
                .failureHandler(
                        ...
                        (httpServletRequest, httpServletResponse, authentication) -> {
                            Resp resp = adminBItemService.login(httpServletRequest);
                            httpServletResponse.setContentType("application/json;charset=utf-8");
                            PrintWriter out = httpServletResponse.getWriter();
                            out.write(new Gson().toJson(resp));
                            out.flush();
