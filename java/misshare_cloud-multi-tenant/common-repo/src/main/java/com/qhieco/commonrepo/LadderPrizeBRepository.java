 ...
 * ${说明}
 */
public interface LadderPrizeBRepository extends JpaRepository<LadderPrizeB, Integer>, JpaSpecificationExecutor<LadderPrizeB> {
     ...
     */
    @Modifying
    @Query("update LadderPrizeB set state = :state where id in(:ids)")
